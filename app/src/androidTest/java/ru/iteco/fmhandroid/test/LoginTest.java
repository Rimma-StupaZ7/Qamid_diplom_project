...
public class LoginTest extends BaseTest {
    ...
    public static String SPASE_PASSWORD = " password";
    ...
    @Test
    @Story("Вход с логином и пробел паролем")
    @Description("Проверка возможности входа в систему с логином и пробел + валидным паролем password2")
    public void appLoginTestSpaseLoginAndPassword() {
        unsuccessfulLogIn(LOGIN, SPASE_PASSWORD);
        LoginPage loginPage = new LoginPage();
        loginPage.waitUntilErrorMessageLoaded();
